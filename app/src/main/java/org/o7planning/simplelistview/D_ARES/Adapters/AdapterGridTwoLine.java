package org.o7planning.simplelistview.D_ARES.Adapters;
...
public class AdapterGridTwoLine extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.z_item_grid_image_two_line, parent, false);
