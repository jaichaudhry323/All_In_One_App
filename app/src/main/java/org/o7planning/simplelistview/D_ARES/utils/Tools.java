package org.o7planning.simplelistview.D_ARES.utils;
...
import org.o7planning.simplelistview.D_ARES.model.DeviceInfo;
...
public class Tools {
    ...
    public static void displayImageOriginal(Context context, ImageView img, @DrawableRes int drawable) {
        try {
            Glide.with(context)
                    .load(drawable)
